...
public boolean selectByCssItem(String selectEle) {
	 try {
         // identify element
		 new WebDriverWait(driver,30).until(ExpectedConditions.elementToBeClickable(By.cssSelector(selectEle)));
	...
	public void selectItemRating(String ratingEle) {
		new WebDriverWait(driver, 90).ignoring(StaleElementReferenceException.class).until(ExpectedConditions.presenceOfElementLocated(By.cssSelector(ratingEle)));

		rating = driver.findElement(By.cssSelector(ratingEle)).getAttribute("innerHTML");
